      ...
      <div className="bg-white rounded-3xl w-full max-w-lg shadow-2xl animate-slideUp overflow-hidden">
        ...
        <div className="flex items-center justify-between px-5 pt-5 pb-3">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-xl bg-[#1B4332]/10 flex items-center justify-center">
              <GitMerge size={16} className="text-[#1B4332]" />
            </div>
            <div>
          ...
          {[person1, person2].map((person, idx) => (
            <div key={idx}
              ...
              <div className="text-center space-y-1.5">
                ...
                {person?.user_id && (
                  <span className="inline-flex items-center gap-1 text-[10px] font-medium text-[#1B4332] bg-[#1B4332]/8 px-2 py-0.5 rounded-full">
        ...
        <div className="px-5 pb-5 pt-3 space-y-2 border-t border-gray-100">
          <button
            ...
            disabled={processing}
            className="w-full py-3.5 bg-[#1B4332] text-white rounded-2xl text-sm font-bold hover:bg-[#1B4332]/90 active:scale-[0.98] transition-all shadow-lg shadow-[#1B4332]/20 flex items-center justify-center gap-2 disabled:opacity-50"
          >
