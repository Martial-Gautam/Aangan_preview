      ...
      <div className="bg-white rounded-3xl w-full max-w-lg shadow-2xl animate-slideUp overflow-hidden">
        ...
        <div className="flex items-center justify-between px-5 pt-5 pb-3">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-xl bg-[#2A4365]/10 flex items-center justify-center">
              <GitMerge size={16} className="text-[#2A4365]" />
            </div>
            <div>
        ...
        <div className="px-5 pb-5 pt-3 space-y-2 border-t border-gray-100">
          <button
            ...
            disabled={processing}
            className="w-full py-3.5 bg-[#2A4365] text-white rounded-2xl text-sm font-bold hover:bg-[#2A4365]/90 active:scale-[0.98] transition-all shadow-lg shadow-[#2A4365]/20 flex items-center justify-center gap-2 disabled:opacity-50"
          >
