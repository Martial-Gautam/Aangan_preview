  ...
  return (
    <LegalLayout
      ...
      intro={
        <>
          <p>
            These are the terms you agree to by using Apney. They are short on purpose. If you
    ...
    >
      ...
      <p>
        <strong>
          There is no tolerance for objectionable content or abusive users on Apney.
        </strong>
      </p>
      ...
      <p>
        ...
        Apney can be reported from the app, and any user can be blocked. Reports are reviewed and
      ...
      <p>
        Apney is provided as it is. We do not promise it will be uninterrupted or free of faults,
